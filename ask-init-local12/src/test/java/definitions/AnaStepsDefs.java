...
//        }
    ...
    @And("I choose option number {int} as correct option for {string} question type for question number {int}")
    public void iChooseOptionNumberAsCorrectOptionForQuestionTypeFotQuestionNumber(int optNum, String questType, int questNum) {
        switch (questType){
            case "single-choice":
    ...
    @And("I mark question number {int} as Show-Stopper question")
    public void iMarkQuestionNumberAsShowStopperQuestion(int questNum) {
    ...
    @And("I mark option {int} as my answer for question number {int}")
    public void iMarkOptionAsMyAnswerForQuestionNumber(int optNum, int questNum) {
    ...
    @And("I click on Details button for assignment with quiz name  {string}")
    public void iClickOnDetailsButtonForAssignmentWithQuizName(String quizName) {
        LocalDate myDate = LocalDate.now();
        DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern("MM/dd/yy");
        String currDate = myDate.format(dateFormat);
    ...
    @Then("Actual score points amount should be {string} than Passing score points amount")
    public void actualPointsAmountShouldBeThanPassingScorePointsAmount(String compOp) {
    ...
    @Then("Actual percentage amount should be {string} than Passing percentage points amount")
    public void actualPercentageAmountShouldBeThanPassingPercentagePointsAmount(String compOp) {
        WebElement passP = getDriver().findElement(By.xpath("//td[contains(text(),'Passing points / percentage:')]//following-sibling::td"));
        WebElement actP = getDriver().findElement(By.xpath("//td[contains(text(),'Actual points / percentage:')]//following-sibling::td"));
        String passPS =  passP.getText();
        String actPS = actP.getText();
